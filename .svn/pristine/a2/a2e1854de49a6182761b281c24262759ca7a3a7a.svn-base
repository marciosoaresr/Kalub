...
(function ($, moment) {
	...
	function Plugin(element, options)
	{
		...
		this.params = { date : true, time : true, format : 'DD/MM/YYYY', minDate : null, maxDate : null, currentDate : null, lang : 'en', weekStart : 0, shortTime : false, 'cancelText' : 'Cancel', 'okText' : 'OK','animation' : false};
										...
										'<div class="dtp-date hidden">' +
											'<div>' +
												'<div class="left center p10">' +
													'<a href="javascript:void(0);" class="dtp-select-month-before animated fadeInRight"><i style="color: #fff;" class="icon-arrow-left icons"></i></a>' +
												'</div>' +
												'<div class="dtp-actual-month p80">MAR</div>' +
												'<div class="right center p10">' +
													'<a href="javascript:void(0);" class="dtp-select-month-after animated fadeInleft"><i style="color: #fff;" class="icon-arrow-right icons"></i></a>' +
												'</div>' +
												'<div class="clearfix"></div>' +
											'</div>' +
											...
											'<div>' +
												'<div class="left center p10">' +
													'<a href="javascript:void(0);" class="dtp-select-year-before animated fadeInRight"><i style="color: #fff;" class=icon-arrow-left icons"></i></a>' +
												'</div>' +
												'<div class="dtp-actual-year p80">2014</div>' +
												'<div class="right center p10">' +
													'<a href="javascript:void(0);" class="dtp-select-year-after animated fadeInLeft"><i style="color: #fff;" class="icon-arrow-right icons"></i></a>' +
												'</div>' +
												'<div class="clearfix"></div>' +
											'</div>' +
										'</div>' +
